                  ...
                  <main className="flex-1 overflow-hidden relative z-10">
                        <div className="h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                              <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <section className="bg-[rgba(0,0,0,0.78)] rounded-2xl border border-[#7B61FF]/35 shadow-[0_0_20px_rgba(123,97,255,0.2)] p-5 flex flex-col overflow-hidden">
                                          <div className="mb-4">
                                                <p className="text-xs font-semibold tracking-wide uppercase text-[#00E5FF]">Upload</p>
                                                <h2 className="text-2xl font-bold text-[#F3ECFF] mt-1">Input Image</h2>
                                    ...
                                    <section className="bg-[rgba(0,0,0,0.78)] rounded-2xl border border-[#7B61FF]/35 shadow-[0_0_20px_rgba(123,97,255,0.2)] p-5 overflow-hidden">
                                          <p className="text-xs font-semibold tracking-wide uppercase text-[#00E5FF]">Analysis</p>
                                          <h2 className="text-2xl font-bold text-[#F3ECFF] mt-1">Verification Output</h2>

                                          {!preview && (
                                                <div className="h-[calc(100%-3.5rem)] mt-4 border border-dashed border-[#7B61FF]/30 rounded-xl flex items-center justify-center bg-[#050505]">
                                                      <CobeGlobe
                                          ...
                                          {preview && isAnalyzing && (
                                                <div className="h-[calc(100%-3.5rem)] mt-4 rounded-xl border border-[#7B61FF]/30 bg-[#050505] p-4">
                                          ...
                                          {preview && result && !isAnalyzing && (
                                                <div className="h-[calc(100%-3.5rem)] mt-4 overflow-hidden flex flex-col gap-4">
                                                      {showResultReady ? (
                                                            ...
                                                            <>
                                                                  ...
                                                                  >
                                                                        <div className="flex items-center justify-between">
                                                                              <div>
                                                                                    ...
                                                                                    <p className="text-xl font-bold mt-1" style={{ color: result.abstained ? '#F3ECFF' : '#00E5FF' }}>
                                                                  ...
                                                                  <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 flex-1 min-h-0">
                                                                        <div className="rounded-xl border border-[#7B61FF]/30 bg-[#050505] p-4 min-h-0 overflow-auto">
                                                                                                ...
                                                                                                <div key={layer} className="rounded-lg border border-[#7B61FF]/25 bg-[#0B0B0B] p-3">
                                                                                                      ...
                                                                                                      <div className="grid grid-cols-2 gap-2 mt-3 text-xs">
                                                                                                            <div>
                                                                                                                  ...
                                                                                                                  <p className="text-[#F3ECFF] font-semibold">{status === 'loaded' ? score.toFixed(1) : '--'}</p>
                                                                                                            </div>
                                                                                                            <div>
                                                                                                                  <p className="text-[#E7DEFF]/65">Reliability</p>
                                                                                                                  <p className="text-[#F3ECFF] font-semibold">{status === 'loaded' ? `${Math.round(reliability * 100)}%` : '--'}</p>
                                                                                                            </div>
                                                                                                      </div>
                                                                                                </div>
                                                                                          );
                                                                        ...
                                                                        <div className="rounded-xl border border-[#7B61FF]/30 bg-[#050505] p-4 min-h-0 overflow-hidden">
                                                                              ...
                                                                              <div className="mt-2 h-[calc(100%-2.5rem)] rounded-lg border border-[#7B61FF]/25 bg-[#0B0B0B] p-2">
