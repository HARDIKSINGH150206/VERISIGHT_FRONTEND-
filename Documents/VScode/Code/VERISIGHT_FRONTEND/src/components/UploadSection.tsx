                  ...
                  >
                        ...
                        {isLoading ? (
                              <div className="relative z-10 space-y-4">
                                    <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto animate-pulse text-white font-bold shadow-[0_0_20px_rgba(233,30,140,0.5),0_0_40px_rgba(0,229,255,0.35)]" style={{ background: 'linear-gradient(135deg, #e91e8c, #7b61ff, #00e5ff)' }}>
                                          <span>AI</span>
                                    </div>
                                    <div>
                                    ...
                                    <div className="w-full bg-[#0B0B0B] rounded-full h-2 overflow-hidden">
                                          <div
